...
//                .map(entry -> new ExternalRegionRow(
//                        entry.getKey(),
//                        entry.getValue(),
...
//
//    @Override
//    public List<ExternalIndicatorRow> collectIndicators(SyncIndicatorsCommand command) {
...
//    }
//
//    private List<ExternalIndicatorRow> collectIndicators(IndicatorGroupCode groupCode, String requestedPeriod) {
...
//    }
//
//    private List<ExternalIndicatorRow> collectIncomeIndicators(String requestedPeriod) {
...
//    }
//
//    private List<ExternalIndicatorRow> collectFinSourceIndicators(String requestedPeriod) {
//        return collectTreeIndicators(
...
//    }
//
//    private List<ExternalIndicatorRow> collectTreeIndicators(
...
//                .map(parsed -> new ExternalIndicatorRow(
//                        parsed.code(),
//                        parsed.caption(),
//                        groupCode,
//                        parsed.parentCode(),
