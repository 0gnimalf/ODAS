...
//
//    @Override
//    public ExternalDatasetPayload collect(AnalyzeBudgetDataCommand command) {
//        validate(command);
//
...
//    }
//
//    private ExternalDatasetPayload collectDetail(AnalyzeBudgetDataCommand command, DetailCollectionSpec spec) {
...
//        );
//
//        List<ExternalObservationRow> observations = observationMapper.mapDetailObservationsForRegion(
//                territoryCode,
...
//    }
//
//    private ExternalDatasetPayload collectCredit(AnalyzeBudgetDataCommand command) {
...
//        );
//
//        List<ExternalObservationRow> observations = observationMapper.mapCreditObservationsForIndicator(
...
//    }
//
//    private ExternalDatasetPayload buildDataset(
